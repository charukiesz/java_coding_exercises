...
public class Exercise005Test {
    ...
    @Test
    public void checkSentenceWithCommasIsAPangram() {
        assertTrue(ex005.isPangram("the, quick, brown, fox, jumps, over, the, lazy, dogs"));
    }

    @Test
    public void checkSentenceWithDashesIsAPangram() {
        assertTrue(ex005.isPangram("the-quick-brown-fox-jumps-over-the-lazy-dogs"));
    }
